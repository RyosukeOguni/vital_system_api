...
class CreateVitalsTable extends Migration
{
  ...
  public function up()
  {
    Schema::create('vitals', function (Blueprint $table) {
      ...
      $table->boolean('lunch')->nullable()->comment('昼食');
      ...
      $table->boolean('snack')->nullable()->comment('おやつ');
      ...
      $table->boolean('medicine')->nullable()->comment('服薬');
      $table->time('medicine_time')->nullable()->comment('服薬時間');
      $table->boolean('vomiting')->nullable()->comment('嘔吐');
      $table->time('vomiting_time')->nullable()->comment('嘔吐時間');
      $table->integer('attack1')->nullable()->comment('発作１');
      ...
      $table->integer('attack2')->nullable()->comment('発作２');
      ...
      $table->integer('attack3')->nullable()->comment('発作３');
      ...
      $table->boolean('aspiration')->nullable()->comment('吸引');
      $table->time('aspiration_time')->nullable()->comment('吸引時間');
      $table->integer('aspiration_point')->nullable()->comment('吸引場所');
      $table->integer('aspiration_color')->nullable()->comment('吸引物色');
      $table->integer('aspiration_type')->nullable()->comment('吸引質');
      $table->text('aspiration_note')->nullable()->comment('吸引備考');
      $table->boolean('injection')->nullable()->comment('注入');
      $table->time('injection_start')->nullable()->comment('注入開始時間');
      $table->time('injection_end')->nullable()->comment('注入終了時間');
      $table->integer('injection_point')->nullable()->comment('注入場所');
      ...
      $table->text('total_vital_note')->nullable()->comment('状態記録備考');
