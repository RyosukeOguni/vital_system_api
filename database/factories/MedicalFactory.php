...
class MedicalFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'attack1' => $this->faker->randomElement($attacks),
            ...
            'attack2' => $this->faker->randomElement($attacks),
            ...
            'attack3' => $this->faker->randomElement($attacks),
            ...
            'aspiration_color' => $this->faker->randomElement($aspiration_colors),
            'aspiration_type' => $this->faker->randomElement($aspiration_types),
            ...
            'injection_point' => $this->faker->randomElement($points),
